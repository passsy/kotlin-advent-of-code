...
object Day2_BathroomSecurity {
    ...
    val pad9 = hashMapOf<Pair<Int, Int>, String>().apply {
        put(-1 to 1, "1")
        put(0 to 1, "2")
        put(1 to 1, "3")
        put(-1 to 0, "4")
    ...
    fun buttons(instructions: List<List<Char>>,
                pad: HashMap<Pair<Int, Int>, String>): List<String> {
        ...
        for (moves in instructions) {
            ...
            for (char in moves) {
                val next = when (char) {
                    ...
                    'R' -> x + 1 to y
                    'D' -> x to y - 1
                    else -> throw IllegalArgumentException("$char is not a valid instruction")
                }
    ...
    val pad13 = hashMapOf<Pair<Int, Int>, String>().apply {
        put(-1 to 1, "2")
        put(0 to 1, "3")
        put(1 to 1, "4")
        put(-2 to 0, "5")
