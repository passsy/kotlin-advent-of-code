...
object Day09_StreamProcessing {
    ...
    val part1 = challenge("Day 9 - Part One") {
        solve {
            result = parse(inputFile("2017/9.txt")).groupScore //17537
        }
    }
    ...
    fun parse(input: String): StreamData {
        ...
        input.forEach {
            ...
            when (it) {
                ...
                ',' -> {
                    // do nothing, forward to next char
                }
        ...
        return StreamData(groups, groupScore, garbageCount)
    }

    data class StreamData(val groups: Int, val groupScore: Int, val garbageCount: Int)
    ...
    val part2 = challenge("Day 9 - Part Two") {
        solve {
            result = parse(inputFile("2017/9.txt")).garbageCount //7539
        }
    }
}
